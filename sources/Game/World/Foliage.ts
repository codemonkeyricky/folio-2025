...
export class Foliage
{
    ...
    material!: {
        threshold: any
        seeThroughPosition: any
        seeThroughEdgeMin: any
        seeThroughEdgeMax: any
        instance: any
        shadowOffset: any
    }
    ...
    constructor(references: any[], colorANode: any, colorBNode: any, seeThrough: boolean = false)
    {
    ...
    setMaterial()
    {
        this.material = {
            threshold: null,
            seeThroughPosition: null,
            seeThroughEdgeMin: null,
            seeThroughEdgeMax: null,
            instance: null,
            shadowOffset: null
        }
        ...
        const colorNode = Fn(() =>
        {
            const mixStrength = float(normalWorld.dot(this.game.lighting.directionUniform).smoothstep(0, 1))
        ...
        this.material.instance.castShadowNode = Fn(() =>
        {
            ...
            alphaColor.lessThan(float(0.5)).discard()
            return vec4(float(0), float(1), float(1), float(1))
        })()
    }
